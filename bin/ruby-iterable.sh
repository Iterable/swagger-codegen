...
if [ "$ENV" = "prod" ]; then
  ags="$@ src/main/scala/com/iterable/codegen/Ruby.scala http://api.iterable.com/api-docs.json $API_KEY"
else
  ags="$@ src/main/scala/com/iterable/codegen/Ruby.scala http://localhost:9000/api-docs.json $API_KEY"
fi
